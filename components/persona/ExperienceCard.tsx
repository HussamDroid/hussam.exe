    ...
    <div className="flex gap-6 items-start">
      ...
      <div className="flex-1">
        <div className="flex items-center gap-2 mb-1">
          <h3 className="text-[20px] font-bold text-white tracking-tight leading-none">AI Specialist</h3>
        </div>
        <p className="text-lg font-medium text-cyan-400 leading-tight mb-2">
          Black Rose Trading (Doha, Qatar)
        </p>
        <p className="text-gray-500 font-mono text-xs mb-6 tracking-widest">2026 — Present</p>
